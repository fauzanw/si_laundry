                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="pelanggan" required="required">
                            ...
                            <option
                                ...
                                value="<?= $d['pelanggan_id']; ?>"><?php echo $d['pelanggan_nama']; ?></option>
                            <?php 
                                }
                            ?>
                        </select>
