...
<div class="container">
    <div class="panel">
        ...
        <div class="panel-body">
            <a href="transaksi_tambah.php" class="btn btn-sm btn-primary pull-right">Transaksi Baru</a>
            <br />
            <br />
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <a href="transaksi_invoice.php?id=<?= $d['transaksi_id']; ?>"
                            class="btn btn-sm btn-warning">Invoice </a>
                        <a href="transaksi_edit.php?id=<?= $d['transaksi_id']; ?>" class="btn btn-sm btn-primary">Edit
                        </a>
